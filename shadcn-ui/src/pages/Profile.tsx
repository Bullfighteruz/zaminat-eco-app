...
const Profile: React.FC = () => {
  ...
  const mockLeaderboard = [
    { rank: 1, name: t('leaderboardUser1'), points: 14400, avatar: '👩‍🌾' },
    { rank: 2, name: t('leaderboardUser2'), points: 13200, avatar: '👨‍💼' },
    { rank: 3, name: t('leaderboardUser3'), points: 12800, avatar: '👩‍🎓' },
    { rank: 4, name: t('leaderboardUser4'), points: 11900, avatar: '👨‍🔬' },
    { rank: 5, name: t('leaderboardUser5'), points: 11200, avatar: '👩‍💻' }
  ];
                ...
                >
                  {isAvailable ? (
                    ...
                    <>
                      ...
                      {t('needMore')} {offer.minCoins - userProgress.ecoCoins} {t('more')} 🪙
                    </>
                  )}
                </Button>
              </motion.div>
                        ...
                        {levelExpanded && (
                          ...
                          >
                            ...
                            <motion.ul 
                              ...
                              variants={levelBenefitsVariants}
                            >
                              <motion.li variants={benefitItemVariants}>• {t('accessExclusiveOffers')}</motion.li>
                              <motion.li variants={benefitItemVariants}>• {t('priorityEventRegistration')}</motion.li>
                              <motion.li variants={benefitItemVariants}>• {t('monthlyBonusCoins')}</motion.li>
                              <motion.li variants={benefitItemVariants}>• {t('specialRecognitionBadges')}</motion.li>
                            </motion.ul>
                          </motion.div>
                        )}
                      </AnimatePresence>
